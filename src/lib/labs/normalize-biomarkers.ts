...
const BIOMARKER_ALIASES: Record<string, string> = {
  ...
  IRON_BIND_CAP_TIBC: "TIBC",
  IRON_BINDING_CAPACITY: "TIBC",
  IRON_SATURATION: "IRON_SAT",
  IRON_SAT_PCT: "IRON_SAT",
  TRANSFERRIN_SATURATION: "IRON_SAT",
  UNSATURATED_IRON_BINDING: "UIBC",
  ...
  ESTRADIOL_SENSITIVE: "ESTRADIOL",
  ESTRADIOL_E2: "ESTRADIOL",
  SEX_HORM_BINDING_GLOB: "SHBG",
  SEX_HORMONE_BINDING_GLOBULIN: "SHBG",
  INSULIN_LIKE_GROWTH_FACTOR: "IGF1",
  IGF_1: "IGF1",
  FREE_TESTOSTERONE_PCT: "PCT_FREE_TESTOSTERONE",
  ...
  BUN_CREATININE: "BUN_CREATININE_RATIO",
  EGFR: "EGFR",
  GFR: "EGFR",
