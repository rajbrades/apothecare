...
const features = [
  {
    icon: <ShieldCheck size={22} className="text-[var(--color-brand-600)]" />,
  ...
  {
    icon: <Stethoscope size={22} className="text-[var(--color-brand-600)]" />,
  ...
  {
    icon: <Zap size={22} className="text-[var(--color-brand-600)]" />,
  ...
  {
    icon: <Sparkles size={22} className="text-[var(--color-brand-600)]" />,
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {features.map((f, i) => (
            <ScrollReveal key={f.title} delay={i * 100}>
              <div className="h-full p-6 rounded-2xl bg-[var(--color-surface-secondary)] border border-[var(--color-border-light)] hover:border-[var(--color-brand-300)] hover:bg-[var(--color-brand-50)]/50 transition-all">
