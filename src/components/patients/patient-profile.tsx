  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-6">
      ...
      <div className="relative mb-6">
        <div className="flex items-center gap-1 border-b border-[var(--color-border-light)] overflow-x-auto scrollbar-hide touch-pan-x -mb-px">
          {tabs.map(({ key, label, icon: Icon }) => (
            <button
              key={key}
              onClick={() => setActiveTab(key)}
              className={`flex items-center gap-1.5 px-3 sm:px-4 py-2.5 text-xs sm:text-sm font-medium border-b-2 transition-colors whitespace-nowrap flex-shrink-0 min-h-[44px] ${
                activeTab === key
