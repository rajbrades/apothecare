...
export async function GET(
  ...
  try {
    ...
    const { data: patient, error } = await supabase
      .from("patients")
      .select("id, practitioner_id, first_name, last_name, date_of_birth, sex, chief_complaints, medical_history, current_medications, supplements, allergies, notes, clinical_summary, ifm_matrix, preferred_evidence_sources, is_archived, created_at, updated_at")
      .eq("id", id)
