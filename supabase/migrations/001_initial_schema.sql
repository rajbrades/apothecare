...
('TSH', 'Thyroid Stimulating Hormone', 'thyroid', 0.45, 4.5, 'mIU/L', 1.0, 2.0, 'Primary marker for thyroid function', 'Functional range catches subclinical thyroid dysfunction earlier. Values above 2.0 may indicate early thyroid stress.', 'IFM / A4M Guidelines'),
...
('HOMOCYSTEINE', 'Homocysteine', 'methylation', 0, 15, 'µmol/L', 0, 7, 'Methylation and cardiovascular marker', 'Elevated homocysteine indicates methylation dysfunction. Functional target <7 reduces CVD risk.', 'A4M / Cleveland Clinic FM'),
...
('FASTING_INSULIN', 'Fasting Insulin', 'metabolic', 2.6, 24.9, 'µIU/mL', 2.0, 5.0, 'Insulin resistance marker', 'Elevated insulin precedes glucose dysregulation by years. Functional range catches metabolic dysfunction early.', 'A4M Guidelines'),
('HBA1C', 'Hemoglobin A1c', 'metabolic', 4.0, 5.6, '%', 4.8, 5.2, 'Average blood sugar over 2-3 months', 'Functional range is tighter. Values 5.3-5.6 may indicate early glycemic stress.', 'IFM Guidelines'),
...
('MAGNESIUM_RBC', 'Magnesium, RBC', 'nutritional', 4.2, 6.8, 'mg/dL', 5.5, 6.5, 'Intracellular magnesium status', 'Serum magnesium is unreliable. RBC magnesium better reflects tissue stores. Optimal is upper range.', 'IFM Guidelines'),
