...
export default function BubbleTestB() {
  return (
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          <div className="text-center space-y-2">
            <h1 className="text-3xl font-bold">Chat Bubble Variation B</h1>
            <p className="text-muted-foreground">2px border with slate-350 color and subtle shadow</p>
          </div>
          ...
          <Card className="overflow-hidden border-2 shadow-xl">
            ...
            <div className="bg-white p-12 space-y-8">
              {/* Variation B: 2px border, medium slate color with shadow */}
              <div className="bg-slate-50 border-2 border-slate-350 rounded-xl p-5 max-w-2xl ml-auto shadow-sm" style={{ borderColor: '#94a3b8' }}>
